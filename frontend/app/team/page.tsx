...
export default function Team() {
  ...
  return (
      <div className="container py-8 max-w-7xl mx-auto">
        <h1 className="text-3xl text-sky-600 dark:text-sky-400 font-bold mb-6">The Team</h1>
        <h2 className="text-xl text-sky-600 dark:text-sky-400 mb-8">The AGENTIVE project is made possible by:</h2>
