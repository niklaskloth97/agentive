/*
  ABOUT PAGE LAYOUT
  - Tailwind CSS + React JSX
  - Image files should be placed in /public
  - Uses the same mask-wave structure as the home page
*/
...
export default function AboutPage() {
  return (
    <main className="w-full overflow-hidden">
        ...
        <section className="relative w-full h-[70vh] md:h-[80vh] flex items-center justify-center isolate">
            ...
            <h1 className="text-white text-3xl md:text-4xl font-bold mb-2">About AGENTIVE</h1>
    ...
    {/* Erasmus+ Initiative */}
    <section className="px-4 md:px-16 py-12 text-center relative">
    ...
    <section className="px-4 md:px-16">
        <h2 className="text-2xl font-cherry text-center text-figmaGreen mb-6">Innovation and Impact</h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-white mb-10">
            <div className="bg-figmaGreen p-6 rounded-lg shadow-md">
                <h3 className="text-lg font-bold mb-2">Digital resources for multilingual literacy</h3>
                <p className="text-sm">
                The project provides open access digital materials that promote multilingual storytelling, language learning and
                literacy skills, addressing a key gap in early childhood education.
                </p>
            </div>
            <div className="bg-figmaGreen p-6 rounded-lg shadow-md">
                <h3 className="text-lg font-bold mb-2">Equipping educators</h3>
                <p className="text-sm">
                By equipping pre-service and in-service teachers with science-based tools and evidence-informed digital
                competences, AGENTIVE empowers professionals to support multilingual teaching effectively.
                </p>
            </div>
            <div className="bg-figmaGreen p-6 rounded-lg shadow-md">
                <h3 className="text-lg font-bold mb-2">Cross-Sector collaboration</h3>
                <p className="text-sm">
                The synergy between academia and business enhances the development of child-driven educational content and
                fosters sustainable partnerships.
                </p>
            </div>
        </div>
    </section>
  ...
  <div className="flex justify-center items-center gap-2 mb-4">
    <h2 className="text-2xl font-cherry text-figmaGreen">A Model for the Future</h2>
