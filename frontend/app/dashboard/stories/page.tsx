...
export default function Page() {
    ...
    const [selectedType, setSelectedType] = useState<"json" | "array" | null>(
        null
    );
    ...
    const breadcrumbItems = [
        {
            label: (
                <TranslateButtons
                    translationKey="multilingual-ressources"
                        ...
                        {selectedType === "json" && selectedStory && (
                            <div className="flex flex-col h-full">
                                <div className="flex-1 flex flex-col items-center justify-center">
                                    {(() => {
                                        const story = typedStoriesData.find(
                                        ...
                                        return (
                                            <>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl">
                                                    {/* Listen */}
                                                    <Link
                                                        href={`/dashboard/stories/${story.id}/listening`}
                                                        className="w-full"
                                                    >
                                                        <button
                                                        ...
                                                        >
                                                            <Headphones
                                                                className="h-36 w-36 md:h-48 md:w-48 text-blue-600"
                                                                strokeWidth={1.5}
                                                            />
                                                    ...
                                                    {/* Read */}
                                                    <Link
                                                        href={`/dashboard/stories/${story.id}/reading`}
                                                        className="w-full"
                                                    >
                                                        <button
                                                        ...
                                                        >
                                                            <BookOpen
                                                                className="h-36 w-36 md:h-48 md:w-48 text-yellow-600"
                                                                strokeWidth={1.5}
                                                            />
                                                    ...
                                                    >
                                                        <button
                                                            className="w-full h-48 md:h-32 rounded-xl bg-green-200 hover:bg-green-300 flex flex-col md:flex-row items-center justify-center shadow-lg transition-all duration-200 hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-green-300"
                                                            aria-label="View activities"
                                                        >
                                                            <BookOpen
                                                                className="h-16 w-16 md:h-12 md:w-12 text-green-600 md:mr-4"
                                                                strokeWidth={1.5}
                                                            />
                                                            <span className="text-lg font-semibold text-green-600 mt-2 md:mt-0">
                                                                <TranslateButtons
