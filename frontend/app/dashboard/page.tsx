...
export default function Page() {
  ...
  const learningmaterial = [
    ...
    { title: 'Paul Pirate explores foreign lands', excerpt: 'Dialogic reading about dealing with different cultures', image: '/images/stories/pirate-story/4.webp', link: '/dashboard/multilingual-stories/a-pirate-story' },
