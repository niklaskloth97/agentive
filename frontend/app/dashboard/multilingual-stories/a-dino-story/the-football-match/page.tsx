...
export default function Page() {
    ...
    const breadcrumbItems = [
      ...
      { label: "The football Match", href: "/dashboard/multilingual-stories/a-dino-story/the-football-match" }
    ];
    ...
    <div className="container mx-auto py-8 px-8">
            <h1 className="text-3xl font-bold mb-6 "> Leere Seite für The football Match</h1>
