...
export default function Page() {
    ...
    const breadcrumbItems = [
      ...
      { label: "Shopping Tour", href: "/dashboard/multilingual-stories/a-dino-story/shopping-tour" }
    ];
    ...
    <div className="container mx-auto py-8 px-8">
            <h1 className="text-3xl font-bold mb-6 "> Leere Seite für Shopping Tour</h1>
