...
export default function Page() {
    ...
    const breadcrumbItems = [
      ...
      { label: "Dino on a trip", href: "/dashboard/multilingual-stories/a-dino-story/dino-on-a-trip" }
    ];
    ...
    <div className="container mx-auto py-8 px-8">
            <h1 className="text-3xl font-bold mb-6 "> Leere Seite für Dino on a trip</h1>
