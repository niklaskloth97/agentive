  ...
  return (
      <div className="container mx-auto py-8">
        ...
        <h2 className="text-m font-semibold mb-4">What Can You Expect?</h2>
          <p className="text-gray-600 mb-4"> 
            This website is just the beginning - think of it as a sneak peek into what is to come. AGENTIVE aims to create resources that celebrate linguistic diversity, promote inclusion, and enable children to thrive in a multilingual world. Our materials will be openly available under open-source licenses, such as Creative Commons, to ensure educators, parents, and schools can adapt and share them freely. Stay tuned as we develop and release these exciting resources in the coming months!
            </p>
        <h2 className="text-m font-semibold mb-4">Who Are We?</h2>
          <p className="text-gray-600 mb-4"> 
        ...
        <h2 className="text-m font-semibold mb-4">Curious About the Team Behind AGENTIVE?</h2>
          <p className="text-gray-600 mb-4"> 
        ...
        <h2 className="text-m font-semibold mb-4">Follow Our Journey</h2>
          <p className="text-gray-600 mb-4"> 
          From project milestones to insights about multilingualism, we’ll be sharing updates, reflections, and behind-the-scenes moments on our blog. Want to stay in the loop? Read the latest updates here. Stay tuned! 
            </p>   
            <p className="text-gray-600 mb-4 "> 
