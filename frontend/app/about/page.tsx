export default function About() {
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl text-green-800 dark:text-green-600 font-bold mb-6">About the Project: AGENTIVE </h1>
      <h2 className="text-xl text-green-800 dark:text-green-600 font-semibold mb-4">Stimulating Multilingual Learning in Early Childhood Education</h2>
      <div className="flex flex-col md:flex-row gap-8">
        {/* <div className="md:w-1/2">
          <Image src="/placeholder.svg" alt="About AGENTIVE" width={500} height={300} className="rounded-lg mb-4" />
        </div> */}
        <div /*className="md:w-1/2"*/>
          <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Our Vision: Promoting Multilingualism in Early Childhood</h2>
          ...
          <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">An EU-Funded Erasmus+ Initiative</h2>
          <p className="text-gray-600 dark:text-white mb-4">
          ...
          <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Collaboration Across Sectors</h2>
          <p className="text-gray-600 dark:text-white mb-4">
          ...
          <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Addressing a Multilingual Europe</h2>
          <p className="text-gray-600 dark:text-white mb-4">
          ...
          <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Open Access to Resources</h2>
          <p className="text-gray-600 dark:text-white mb-4">
          ...
          <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Objectives of the Project</h2>
          ...
          <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Innovation and Impact</h2>
          ...
          <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Alignment with EU Goals</h2>
          <p className="text-gray-600 dark:text-white mb-4">
          ...
          <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">A Model for the Future</h2>
          <p className="text-gray-600 dark:text-white mb-4">
