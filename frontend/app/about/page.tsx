  ...
  return (
    <div className="container mx-auto py-8 px-8">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div /*className="md:w-1/2"*/>
          <h2 className="text-m font-semibold mb-2">Our Vision: Promoting Multilingualism in Early Childhood</h2>
          ...
          <h2 className="text-m font-semibold mb-2">An EU-Funded Erasmus+ Initiative</h2>
          <p className="text-gray-600 dark:text-white mb-4">
          ...
          <h2 className="text-m font-semibold mb-2">Collaboration Across Sectors</h2>
          <p className="text-gray-600 dark:text-white mb-4">
          ...
          <h2 className="text-m font-semibold mb-2">Addressing a Multilingual Europe</h2>
          <p className="text-gray-600 dark:text-white mb-4">
          ...
          <h2 className="text-m font-semibold mb-2">Open Access to Resources</h2>
          <p className="text-gray-600 dark:text-white mb-4">
          ...
          <h2 className="text-m font-semibold mb-2">Alignment with EU Goals</h2>
          <p className="text-gray-600 dark:text-white mb-4">
