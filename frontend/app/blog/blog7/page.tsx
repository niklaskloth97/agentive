  ...
  return (
    <div className="container mx-auto py-8 px-8">
      <h1 className="text-3xl font-bold mb-6">
        Story 4 - Sleeping at a friend’s
      </h1>

      <h2 className="text-xl font-semibold mb-4">
        Meet the authors and contributors that wrote the fourth story about
        Bobba!
      </h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
        ...
        <div className="md:w-1/2">
          <Image
            src="/learning-material/story-4/story-en/Story 4_2 title_E.jpeg"
            alt="Bobba the alien"
            width={500}
            height={500}
        ...
        <div className="md:w-1/2">
          <p className="text-gray-600 mb-6 dark:text-white leading-relaxed">
            In this fourth installment, Bobba experiences his very first
            sleepover! Joining his friend Olivia, Bobba learns all about
            nighttime routines and the joy of friendship on Earth. This
            heartwarming chapter is brought to life through our global
            community, and we want to give a big thanks to all the translators
            and recorders for participating in making this story possible!
            <br />
            <br />
            Follow Bobba and Olivia&apos;s nighttime adventure in &quot;Sleeping
            at a friend’s,&quot; available on the AGENTIVE Platform in multiple
          ...
          <div className="text-gray-800 dark:text-gray-100 space-y-1 border-t pt-4 border-gray-200 dark:border-gray-700">
            <p>
              <span className="font-bold">Author(s):</span>Angélique Quintus,
              Claudine Kirsch, Jeanne Letsch (UNILU)
            </p>
            <p>
