export default function About() {
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6  text-green-800 dark:text-green-600 ">Welcome to AGENTIVE </h1>
      <h2 className="text-xl font-semibold text-green-800 mb-4 dark:text-green-600"> Our &quot;Virtual Window&quot; to the Future of Multilingual Education </h2>
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div /*className="md:w-1/2"*/>
          ...
          <h2 className="text-m font-semibold text-green-800 mb-2 dark:text-green-600"> A Platform for Open Education </h2>
          ...
          <h2 className="text-m font-semibold mb-2 text-green-800 dark:text-green-600"> A Glimpse of What&apos;s to Come </h2>
          <div className="text-gray-600 mb-4 dark:text-white">
          ...
          <h2 className="text-m font-semibold mb-2 text-green-800 dark:text-green-600"> Our Platform Concept (For the Tech Enthusiasts here) </h2>
