export default function About() {
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6 font-serif text-green-900 ">Welcome to AGENTIVE </h1>
      <h2 className="text-xl font-semibold font-serif text-green-700 mb-4"> Our &quot;Virtual Window&quot; to the Future of Multilingual Education </h2>
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div /*className="md:w-1/2"*/>
          ...
          <h2 className="text-m font-semibold font-serif text-green-700 mb-2"> A Platform for Open Education </h2>
          <div className="text-gray-600 mb-4">
            <p className='mb-1'>At the heart of AGENTIVE is the principle of openness:</p>
            <ul className="list-disc ml-8">
                <li className="mb-1">
                    <p className='font-semibold'>	Open-Source Platform: 
                    </p>
                </li>
                ...
                <li className="mb-1">
                    <p className='font-semibold'>	Open Licensing:
                    </p>
                 <p className = 'font-sembibold'> The materials we create will be available under an open-source license, such as a Creative Commons license, enabling educators, schools, and families to adapt and share resources. The specific licensing terms are still under discussion, but our focus remains on maximizing accessibility and collaboration.
                    </p>
                </li>
                <li className= "mb-1">
                <p className = 'font-semibold'>  Accessibility in Mind: 
                    </p>
                </li>
                    <p className = 'font-sembibold'> AGENTIVE is built on the philosophy that public projects funded by public money should provide public access. Our platform and code are open source, embracing the mantra &quot;public money, public code&quot;. 
                    </p>
            </ul>
          </div>

          <h2 className="text-m font-semibold mb-2 font-serif text-green-700"> A Glimpse of What&apos;s to Come </h2>
          <div className="text-gray-600 mb-4">
            ...
            <ul className="list-disc ml-8">
                <li className="mb-1">
                    <p className='font-semibold'>	Open-Access Materials:
                    </p>
                </li>
                 <p className = 'font-sembibold'> 
                ...
                <li className="mb-1">
                    <p className='font-semibold'>	Privacy-Preserving Analytics:
                    </p>
                 <p className = 'font-sembibold'> As we grow, understanding how our platform is used will be critical. We are exploring privacy-preserving analytics solutions to ensure we gather insights without compromising user privacy.

                 </p>
                </li>
                <li className= "mb-1">
                <p className = 'font-semibold'> Continuous Platform Development:
                    </p>
                </li>
                    <p className = 'font-sembibold'> Our platform is designed to be flexible and extendable, ensuring we can adapt and improve over time as needs evolve.
                    </p>
            </ul>
          </div>
          ...
          <h2 className="text-m font-semibold mb-2 font-serif text-green-700 "> Our Platform Concept (For the Tech Enthusiasts here) </h2>
