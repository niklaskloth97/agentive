  ...
  return (
    <div className="container mx-auto py-8 px-8">
      ...
      <h2 className="text-xl font-semibold mb-4">
        Meet the authors and contributors that wrote the final story about Bobba!
      </h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
        ...
        <div className="md:w-1/2">
          <Image
            src="/learning-material/story-8/covers/Story 8_title_E.jpg"
            alt="Bobba the alien"
            width={500}
            height={500}
...
<div className="md:w-1/2">
  <p className="text-gray-600 mb-6 dark:text-white leading-relaxed">
    In this final installment, it is time for Bobba to say goodbye. After an
    unforgettable visit to Earth, Bobba prepares for his journey back to his
    home planet, carrying with him the memories and friendships he made.
    This concluding chapter is brought to life through our global community,
    and we want to give a big thanks to all the translators and
  ...
  <div className="text-gray-800 dark:text-gray-100 space-y-1 border-t pt-4 border-gray-200 dark:border-gray-700">
    <p><span className="font-bold">Author(s):</span> Christina vom Brocke (PHGR)</p>
    <p><span className="font-bold">Peer-reviewed:</span> UNILU, UNIBZ, UNIPRI</p>
    <p><span className="font-bold">Pictures:</span> Katerina Veroutos and Christina vom Brocke (PHGR)</p>
  </div>
</div>
      </div>
