...
export default function About() {
  const translations = [
    { language: "Albanian", translator: "Valmire Ymeri" },
    {
      language: "French",
      translator:
        "Carole Dording, Jeanne\n" + "Letsch, Angélique Quintus\n" + "(UNILU)",
    },
    {
      language: "German-Long",
      translator: "Christina vom Brocke\n" + "(PHGR)",
    },
    {
      language: "German",
      translator:
    ...
    {
      language: "Greek",
      translator: "Korina Defteraiou, Stefania\n" + "Oikonomou (W2L)",
    },
    {
      language: "Hungarian",
      translator: "Beti Karakatič, \n" + "Annamária Gróg",
    },
    {
      language: "Italian",
      translator: "Eleonora Conci,\n" + "Francesca Cangemi\n" + "(PHGR)",
    },
    ...
    { language: "Chinese", translator: "Sisi Laoshi" },
  ];

  const recorders = [
    {
      language: "Albanian",
      recorder: "Elza Hoti, Nicolas, \n" + "Donnerup (UNILU) ",
    },
    ...
    { language: "Croatian", recorder: "Kristina Riman" },
    {
      language: "Chinese",
      recorder:
        "Sisi Laoshi\n" +
        "Fiona Cees\n" +
        "Isla Van Oosterom Devlin\n" +
        "Luis Ziegler",
    },
  ];
  ...
  return (
    <div className="container mx-auto py-8 px-8">
      <h1 className="text-3xl font-bold mb-6">Story 8 - Going home</h1>

      <h2 className="text-xl font-semibold mb-4">
        Meet the authors and contributors that wrote the final story about
        Bobba!
      </h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
        ...
        <div className="md:w-1/2">
          <Image
            src="/learning-material/story-8/covers/Story 8_title_E.jpeg"
            alt="Bobba the alien"
            width={500}
            height={500}
        ...
        <div className="md:w-1/2">
          <p className="text-gray-600 mb-6 dark:text-white leading-relaxed">
            In this final installment, it is time for Bobba to say goodbye.
            After an unforgettable visit to Earth, Bobba prepares for his
            journey back to his home planet, carrying with him the memories and
            friendships he made. This concluding chapter is brought to life
            through our global community, and we want to give a big thanks to
            all the translators and recorders for participating in making this
            entire eight-story journey possible!
            <br />
            <br />
            Experience the heartfelt conclusion in &quot;Going home,&quot;
            available across the AGENTIVE Platform in multiple languages thanks
            to the dedicated contributors listed below.
          </p>

          {/* Project Credits */}
          <div className="text-gray-800 dark:text-gray-100 space-y-1 border-t pt-4 border-gray-200 dark:border-gray-700">
            <p>
              <span className="font-bold">Author(s):</span> Christina vom Brocke
              (PHGR)
            </p>
            <p>
              <span className="font-bold">Peer-reviewed:</span> UNILU, UNIBZ,
              UNIPRI
            </p>
            <p>
              <span className="font-bold">Pictures:</span> Katerina Veroutos and
              Christina vom Brocke (PHGR)
            </p>
          </div>
        </div>
      </div>
        ...
        <table className="min-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
          <thead>
            <tr className="bg-gray-100 dark:bg-gray-700 text-left">
              <th className="py-3 px-6 font-semibold uppercase text-sm border-b">
                Language
              </th>
              <th className="py-3 px-6 font-semibold uppercase text-sm border-b">
                Translator
