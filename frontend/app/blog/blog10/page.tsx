  ...
  return (
    <div className="container mx-auto py-8 px-8">
      <h1 className="text-3xl font-bold mb-6">
        Story 7 - Celebrating Olivia’s birthday!
      </h1>

      <h2 className="text-xl font-semibold mb-4">
        Meet the authors and contributors that wrote the seventh story about
        Bobba!
      </h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
        ...
        <div className="md:w-1/2">
          <Image
            src="/learning-material/story-7/covers/Story 7_title_E.jpeg"
            alt="Bobba the alien"
            width={500}
            height={500}
        ...
        <div className="md:w-1/2">
          <p className="text-gray-600 mb-6 dark:text-white leading-relaxed">
            In this seventh installment, it’s time to celebrate! Bobba joins the
            party for Olivia’s birthday, experiencing all the fun, games, and
            traditions of an Earthly birthday celebration. This festive chapter
            is brought to life through our global community, and we want to give
            a big thanks to all the translators and recorders for participating
            in making this celebration possible!
            <br />
            <br />
            Join the festivities in &quot;Celebrating Olivia’s birthday!,&quot;
