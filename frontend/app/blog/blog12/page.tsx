    ...
    <div className="container mx-auto py-12 px-8 max-w-5xl">
      ...
      <header className="text-center mb-12">
        ...
        <p className="text-xl text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
          We&apos;ve just hit a major orbit: Bobba&apos;s stories are now
      ...
      <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
            Bobba&apos;s journey from a planet far, far away just got a lot more
            accessible. To ensure every child can accompany him on his visit to
            Earth, we have expanded the AGENTIVE Platform to support 15
            different languages from across the European continent.
          </p>
          <p>
            Language is the key to the stars. Now, Bobba can say
            &apos;Hello&apos; to almost everyone in Europe!
          </p>
        </div>
      </div>
      ...
      <div className="mt-16 text-center">
        <p className="text-lg mb-6">
          This is just the beginning of our multilingual mission.
        </p>
