...
export default function About() {
  ...
  const recorders = [
    { language: "Albanian", recorder: "Elza Hoti (UNILU)" },
  ...
  return (
    <div className="container mx-auto py-8 px-8">
      <h1 className="text-3xl font-bold mb-6">
        Story 1 - Bobba&apos;s first trip to Earth
      </h1>

      <h2 className="text-xl font-semibold mb-4">
        Meet the authors and contributors that wrote the first story about
        Bobba!
      </h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
        ...
        <div className="md:w-1/2">
          <Image
            src="/learning-material/story-1/story-en/Story1_title_E.jpeg"
            alt="Bobba the alien"
            width={500}
            height={500}
        ...
        <div className="md:w-1/2">
          <p className="text-gray-600 mb-6 dark:text-white leading-relaxed">
            Bobba’s journey from a far-off planet to Earth is brought to life
            through the power of community and collaboration. This project is a
            collective effort, and we want to give a big thanks to all the
            translators and recorders for participating in making this possible!
            <br />
            <br />
            Explore Bobba&apos;s visit to Earth through the eight stories
            available on the AGENTIVE Platform, made accessible in multiple
            languages thanks to the contributors listed below.
          </p>
