export default function About() {
    return (
      <div className="container mx-auto py-8">
        <h1 className="text-3xl text-green-800 dark:text-green-600 font-bold mb-6">Kicking Off AGENTIVE – A Multilingual Education Adventure Begins
        </h1>
        <h2 className="text-xl text-green-800 dark:text-green-600 font-semibold mb-4">From October 3rd to October 5th, the picturesque town of Brixen, hosted by the Free University of Bolzano, became the meeting point for an exciting pan-European initiative: the kickoff of the AGENTIVE project.</h2>
        <p className="text-gray-600 dark:text-white mb-4">This Erasmus+ funded project unites partners from Luxembourg, Switzerland, Germany, Slovenia, Italy, and Greece to revolutionize multilingual education in early childhood through innovative digital resources and collaborative efforts.
        </p>
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div /*className="md:w-1/2"*/>
            <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2 ">A Strong Start: Meeting the Team and Setting the Foundations
            </h2>
            ...
            <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Addressing the Challenge of Multilingualism in Education
            </h2>
            <p className="text-gray-600 dark:text-white mb-4">
            ...
            <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Building a Vision for Multilingual Education
            </h2>
            <p className="text-gray-600 dark:text-white mb-4">
            ...
            <div className="text-gray-600 dark:text-white mb-4">
              <ul className="list-disc ml-8">
                <li className="mb-1">
                <p className='font-semibold'>Developing Generic, Flexible Material:
                  </p>Multilingual resources should be adaptable to the diverse needs of educators, offering autonomy and empowering them to create meaningful teaching experiences.
                  </li>
                <li className="mb-1">
                <p className='font-semibold'>Multimodal and Open-Ended: </p> Literacy content will include books, songs, animations, and even interactive elements, enabling children to engage with languages through various sensory modalities.
                </li>
                <li className="mb-1">
                <p className='font-semibold'>Creative and Inclusive Designs: </p> Characters like adventurers, dinosaurs, and monsters will help bring the materials to life, creating engaging narratives that resonate with children. Themes such as emotions, friendships, and cultural practices (e.g., shopping, traveling) will be interwoven into the stories to provide a rich, relatable and relevant learning experience for children.
                </li>
                <li className="mb-1">
                  <p className='font-semibold'>Digital Innovation:</p>Materials will have a digital component, allowing children to select languages, hear text read aloud, and interact with multilingual content.
                </li>
              </ul>
            </div>

            <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Key Challenges and Solutions</h2>
            ...
            <h2 className="text-m text-green-800 dark:text-green-500 font-semibold mb-2">A Creative and Inclusive Approach
            </h2>
            <p className="text-gray-600 dark:text-white mb-4">
            ...
            <h2 className="text-m text-green-800 dark:text-green-600 font-semibold mb-2">Next Steps: Setting the Wheels in Motion  </h2>
