export default function About() {
    return (
      <div className="container mx-auto py-8">
        <h1 className="text-3xl text-green-800 font-bold mb-6">Kicking Off AGENTIVE – A Multilingual Education Adventure Begins
        </h1>
        <h2 className="text-xl text-green-800 font-semibold mb-4">From October 3rd to October 5th, the picturesque town of Brixen, hosted by the Free University of Bolzano, became the meeting point for an exciting pan-European initiative: the kickoff of the AGENTIVE project.</h2>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div /*className="md:w-1/2"*/>
            <h2 className="text-m text-green-800 font-semibold mb-2 ">A Strong Start: Meeting the Team and Setting the Foundations
            </h2>
            ...
            <h2 className="text-m text-green-800 font-semibold mb-2">Addressing the Challenge of Multilingualism in Education
            </h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-m text-green-800 font-semibold mb-2">Building a Vision for Multilingual Education
            </h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-m text-green-800 font-semibold mb-2">Key Challenges and Solutions</h2>
            ...
            <h2 className="text-m text-green-800 font-semibold mb-2">A Creative and Inclusive Approach
            </h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-m text-green-800 font-semibold mb-2">Next Steps: Setting the Wheels in Motion  </h2>
