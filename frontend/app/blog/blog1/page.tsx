      ...
      <div className="container mx-auto py-8">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <h2 className="text-m font-semibold mb-4 ">A Strong Start: Meeting the Team and Setting the Foundations
            ...
            <h2 className="text-m font-semibold mb-2">Building a Vision for Multilingual Education
            </h2>
            <p className="text-gray-600 dark:text-white mb-4">
            ...
            <h2 className="text-m font-semibold mb-2">A Creative and Inclusive Approach
            </h2>
            <p className="text-gray-600 dark:text-white mb-4">
            ...
            <h2 className="text-m font-semibold mb-2">Next Steps: Setting the Wheels in Motion  </h2>
