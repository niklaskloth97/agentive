...
export default function About() {
  ...
  const recorders = [
    ...
    { language: "Slovenian", recorder: "Silva Bratož (UP)" },
  ...
  return (
    <div className="container mx-auto py-8 px-8">
      <h1 className="text-3xl font-bold mb-6">Story 6 - The Monster castle</h1>

      <h2 className="text-xl font-semibold mb-4">
        Meet the authors and contributors that wrote the sixth story about
        Bobba!
      </h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
        ...
        <div className="md:w-1/2">
          <Image
            src="/learning-material/story-6/covers/Story 6_title_E.jpeg"
            alt="Bobba the alien"
            width={500}
            height={500}
        ...
        <div className="md:w-1/2">
          <p className="text-gray-600 mb-6 dark:text-white leading-relaxed">
            In this sixth installment, Bobba embarks on a thrilling and
            imaginative adventure to the Monster Castle! This story explores
            bravery and creativity as Bobba navigates a world of friendly spooks
            and hidden wonders. This exciting chapter is brought to life through
            our global community, and we want to give a big thanks to all the
            translators and recorders for participating in making this
            imaginative journey possible!
            <br />
            <br />
            Join Bobba on his quest through &quot;The Monster Castle,&quot;
            available on the AGENTIVE Platform in multiple languages thanks to
            the dedicated contributors listed below.
          </p>

          {/* Project Credits */}
          <div className="text-gray-800 dark:text-gray-100 space-y-1 border-t pt-4 border-gray-200 dark:border-gray-700">
            <p>
              <span className="font-bold">Author(s):</span> Marjan Asgari
              (Unibz)
            </p>
            <p>
