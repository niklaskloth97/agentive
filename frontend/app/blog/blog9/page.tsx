  ...
  return (
    <div className="container mx-auto py-8 px-8">
      ...
      <h2 className="text-xl font-semibold mb-4">
        Meet the authors and contributors that wrote the sixth story about Bobba!
      </h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
        ...
        <div className="md:w-1/2">
          <Image
            src="/learning-material/story-6/covers/Story 6_title_E.jpg"
            alt="Bobba the alien"
            width={500}
            height={500}
...
<div className="md:w-1/2">
  <p className="text-gray-600 mb-6 dark:text-white leading-relaxed">
    In this sixth installment, Bobba embarks on a thrilling and imaginative
    adventure to the Monster Castle! This story explores bravery and
    creativity as Bobba navigates a world of friendly spooks and hidden
    wonders. This exciting chapter is brought to life through our global
    community, and we want to give a big thanks to all the
  ...
  <div className="text-gray-800 dark:text-gray-100 space-y-1 border-t pt-4 border-gray-200 dark:border-gray-700">
    <p><span className="font-bold">Author(s):</span> Marjan Asgari (Unibz)</p>
    <p><span className="font-bold">Peer-reviewed:</span> UNILU, UNIBZ, UNIPRI</p>
    <p><span className="font-bold">Pictures:</span> Katerina Veroutos and Marjan Asgari</p>
  </div>
</div>
      </div>
