  ...
  return (
    <div className="container mx-auto py-8 px-8">
      ...
      <h2 className="text-xl font-semibold mb-4">
        Meet the authors and contributors that wrote the second story about Bobba!
      </h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
        ...
        <div className="md:w-1/2">
          <Image
            src="/learning-material/story-2/story-en/Story 2_title_E.jpg"
            alt="Bobba the alien"
            width={500}
            height={500}
        ...
        <div className="md:w-1/2">
          <p className="text-gray-600 mb-6 dark:text-white leading-relaxed">
            In this second installment, Bobba continues his Earthly adventure with a visit
            to a local kindergarten! This expansion of Bobba’s world is made possible through
            continued community collaboration, and we owe a big thanks to all the
          ...
          {/* Project Credits */}
          <div
              className="text-gray-800 dark:text-gray-100 space-y-1 border-t pt-4 border-gray-200 dark:border-gray-700">
            ...
            <p><span className="font-bold">Pictures:</span> Katerina Veroutos, Anja Pirih (UP) and Silva Bratož (UP)
            </p>
          </div>
        </div>
      </div>
