...
export default function About() {
  ...
  const recorders = [
    ...
    { language: "Chinese", recorder: "Sisi Laoshi\n" + "Fiona Cees\n" + "Isla Van Oosterom Devlin\n" + "Luis Ziegler" },
  ...
  return (
    <div className="container mx-auto py-8 px-8">
      ...
      <h2 className="text-xl font-semibold mb-4">
        Meet the authors and contributors that wrote the third story about
        Bobba!
      </h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
        ...
        <div className="md:w-1/2">
          <p className="text-gray-600 mb-6 dark:text-white leading-relaxed">
            In this third installment, Bobba experiences the wonders of the
            seaside! From sandy shores to rolling waves, this sunny chapter of
            his journey is brought to life through our collaborative network. We
            want to give a big thanks to all the translators and recorders for
            their incredible work in making this beach adventure accessible!
            <br />
            <br />
            Join Bobba as he explores the coastal world in &quot;Bobba at the
            Beach&quot; available in various languages on the AGENTIVE Platform
            thanks to the dedicated contributors listed below.
          </p>
