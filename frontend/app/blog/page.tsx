...
export default function Blog() {
  const blogPosts = [
    ...
    { title: 'Website going live', excerpt: 'We just launched the website you can see here. Learn more here', image: '/images/blogThumbnails/blog2.png', link: '/blog/blog2' },
      ...
      { title: 'The open AGENTIVE resources for Multilingual Early Childhood Education', excerpt: 'Bobba and his adventures are now available in 15 languages!', image: '/placeholder.svg', link: '/blog/blog13'}
  ]
