...
export default function About() {
  ...
  const recorders = [
    { language: "Albanian", recorder: "Elza Hoti" },
    ...
    { language: "Greek", recorder: "Potheini Vaiouli (UNILU)" },
  ...
  return (
    <div className="container mx-auto py-8 px-8">
      <h1 className="text-3xl font-bold mb-6">
        {" "}
        Story 5 - Bobba in the library
      </h1>

      <h2 className="text-xl font-semibold mb-4">
        Meet the authors and contributors that wrote the fifth story about
        Bobba!
      </h2>
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center mb-12">
        ...
        <div className="md:w-1/2">
          <Image
            src="/learning-material/story-5/story-en/Story 5_title_E.jpeg"
            alt="Bobba the alien"
            width={500}
            height={500}
        ...
        <div className="md:w-1/2">
          <p className="text-gray-600 mb-6 dark:text-white leading-relaxed">
            In this fifth installment, Bobba discovers the magic of books!
            Surrounded by towering shelves and quiet corners, Bobba explores the
            endless stories and knowledge that Earth has to offer. This quiet
            but curiosity-filled chapter is brought to life through our
            collaborative network, and we want to give a big thanks to all the
            translators and recorders for participating in making this possible!
            <br />
            <br />
            Follow Bobba as he explores the world of literature in &quot;Bobba
            in the Library,&quot; available on the AGENTIVE Platform in multiple
            languages thanks to the dedicated contributors listed below.
          </p>

          {/* Project Credits */}
          <div className="text-gray-800 dark:text-gray-100 space-y-1 border-t pt-4 border-gray-200 dark:border-gray-700">
            <p>
              <span className="font-bold">Author(s):</span> Yasmine Azza (Unibz)
            </p>
            <p>
