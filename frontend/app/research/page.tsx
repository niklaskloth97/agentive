...
export default function Research() {
  const researchPosts = [
    { title: 'Research Page Launched', excerpt: 'Expect to hear more from us!', image: '/placeholder.svg', link: '/research/research1' }
  ]

  return (
      <div className="container mx-auto py-8 px-8">
        <h1 className="text-3xl font-bold mb-6">Academic Findings</h1>
