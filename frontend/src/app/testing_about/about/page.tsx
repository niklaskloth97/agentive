...
const visionItems = [
	{
		title: "Empowering Multilingual Growth",
		color: "text-primary",
		description:
			"AGENTIVE equips children with tools to navigate multilingual environments.",
	},
	{
		title: "Bridging Language Education Gaps",
		color: "text-accent",
		description:
			"Providing accessible, evidence-based resources for multilingual literacy development.",
	},
	{
		title: "Innovative Learning & Collaboration",
		color: "text-ring",
		description:
			"Using pedagogical sets, a digital platform, and professional training to foster collaboration.",
	},
];
const objectives = [
	{
		title:
			"Enhance digital transformation of schools and universities through open access early language learning resources and state-of-the-art pedagogies and training",
		color: "text-primary",
		description:
			" By creating open-access, state-of-the-art pedagogical tools, the project supports the digital readiness of schools and universities. Training programs for pre- and in-service ECE teachers are integral to this goal.",
	},
	{
		title:
			"Leverage open, multilingual and cross-sectoral ECE through university-school-business synergies",
		color: "text-ring",
		description:
			"AGENTIVE fosters partnerships between schools, universities, and businesses to innovate multilingual education. These collaborations ensure the materials and approaches developed are practical, effective, and forward-thinking.",
	},
];
...
const innovationAndImpact = [
	{
		...
		color: "text-primary",
		description:
			"The project provides open, digital materials that promote the learning of languages and literacy, addressing a key gap in early childhood education.",
	},
	{
		title: "Equipping Educators",
		color: "text-primary",
		description:
			" By equipping pre- and in-service teachers with evidence-based strategies and digital competencies, AGENTIVE empowers educators to implement multilingual teaching effectively",
	},
	{
		title: "Cross-Sector Collaboration",
		color: "text-primary",
		description:
			" The synergy between academia and businesses drives the development of innovative educational tools and sustainable partnerships",
	},
];
...
export default function About() {
	return (
		<div className="container mx-auto py-8 px-4">
			<VisionCard title="Our Vision" items={visionItems} />
			...
			<div className="mt-12">
				<VisionCard className="" title="Objectives" items={objectives} />
			</div>

			<div className="mt-12">
				<VisionCard title="Innovation and Impact" items={innovationAndImpact} />
			</div>
