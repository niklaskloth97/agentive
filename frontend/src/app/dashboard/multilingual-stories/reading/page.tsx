...
export default function ReadingPage() {
	...
	const breadcrumbItems = [
		...
		{
			label: "Read",
			href: "/dashboard/multilingual-stories/a-monster-story/read",
		},
	];
				...
				<div className="container mx-auto py-4">
					...
					<div className="flex flex-col md:flex-row w-full gap-6">
						...
						<div className="w-full md:w-1/4 flex flex-col gap-4">
							...
							<CollapsibleCard title="Listen to audio" defaultOpen={true}>
							...
							<CollapsibleCard title="Download Options" className="w-full">
								<div className="space-y-3">
									<p className="text-gray-700">
										Download materials for the selected language.
									</p>
