...
const storyContent = {
	en: {
		...
		images: [
			"/images/stories/pirate-story/1.webp",
			"/images/stories/pirate-story/2.webp",
			"/images/stories/pirate-story/3.webp",
			"/images/stories/pirate-story/4.webp",
		],
	},
	de: {
		label: "Deutsch",
		...
		images: [
			"/images/stories/pirate-story/1.png",
			"/images/stories/pirate-story/.png",
			"/images/pirate3-de.jpg",
		],
	},
	es: {
		label: "Español",
		url: "/audio/test-en.opus",
		images: [
			"/images/pirate1-es.jpg",
			"/images/pirate2-es.png",
			"/images/pirate3-es.jpg",
		],
	},
};
...
export default function Page() {
	...
	const [selectedLanguage, setSelectedLanguage] =
		useState<keyof typeof storyContent>("en");
	...
	const breadcrumbItems = [
		...
		{
			label: "A pirate story",
			href: "/dashboard/multilingual-stories/a-pirate-story",
		},
	];
			...
			<div className="w-full flex flex-col gap-8 px-1 md:px-2 xl:px-2 my-4">
				<div className="w-full max-w-3xl mx-auto relative">
					...
					<Carousel setApi={setApi} className="w-full">
						<CarouselContent>
							{storyContent[selectedLanguage].images.map(
								...
								<div className="flex justify-between items-center">
									<div className="flex items-center gap-2">
										...
										<Select
											...
											onValueChange={(value) =>
												setAudioLanguage(value as keyof typeof storyContent)
											}
										>
							...
							<div className="flex justify-end items-center mb-2">
								<div className="flex items-center gap-2">
									...
									<Select
										...
										onValueChange={(value) =>
											setSelectedLanguage(value as keyof typeof storyContent)
										}
									>
										<SelectTrigger className="w-[180px]">
								...
								<Carousel setApi={setFullscreenApi} className="h-full">
									<CarouselContent className="h-full">
										{storyContent[selectedLanguage].images.map(
											(image: string, index: number) => (
												<CarouselItem
													key={`fullscreen-${selectedLanguage}-${index}`}
													className="h-full"
												>
