...
import ListeningFrame, {
	StoryLanguageContent,
} from "@/components/ListeningFrame";
...
export default function ListeningPage() {
	...
	const breadcrumbItems = [
		...
		{
			label: "Listen",
			href: "/dashboard/multilingual-stories/a-monster-story/listen",
		},
	];
	...
	return (
		...
		>
			<DashboardLayout breadcrumbItems={breadcrumbItems}>
				<h1 className="text-2xl font-bold ml-3 mb-6">
					Listen to Monster Story
				</h1>
				...
				<div className="flex flex-col md:flex-row w-full gap-6">
					...
					<div className="w-full md:w-1/4 flex flex-col gap-4">
						...
						<CollapsibleCard title="Download Options" className="w-full">
							<div className="space-y-3">
								<p className="text-gray-700">
									Downloading downloads the material for the selected language.
								</p>
						...
						<CollapsibleCard title="Follow-up activities" className="w-full">
							<ActivitySelection />
						</CollapsibleCard>
					</div>
					{/* Left Column - 75% */}
