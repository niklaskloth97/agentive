										...
										<>
											<div className="flex flex-col sm:flex-row items-center sm:items-start bg-white dark:bg-gray-800/40 rounded-xl mb-8 max-w-2xl w-full overflow-hidden">
												...
												<div className="w-full sm:w-2/3 p-4 sm:border-l border-gray-200 dark:border-gray-700 flex flex-col justify-center h-full">
													...
													<div className="mt-2 text-sm text-gray-600 dark:text-gray-300">
														<p>
															Available in:{" "}
															{getJsonStoryLanguages(story).join(", ")}
														</p>
													</div>
												</div>
											</div>
											<div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl">
												...
												>
													...
													>
														<BookOpen
															className="h-36 w-36 md:h-48 md:w-48 text-emerald-600"
															strokeWidth={1.5}
														/>
														<span className="text-lg font-semibold text-emerald-600 mt-3">
															Read
														</span>
													</button>
												</Link>
												...
												>
													...
													>
														<Activity
															className="h-36 w-36 md:h-48 md:w-48 text-amber-600"
															strokeWidth={1.5}
														/>
														<span className="text-lg font-semibold text-amber-600 mt-3">
															Activities
														</span>
													</button>
												</Link>
