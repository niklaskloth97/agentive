...
const components: { title: string; href: string; description: string }[] = [
	{
		...
		description: "Reenforce vocabulary with fun activities.",
	},
	{
		title: "Language Awareness",
		href: "/docs/primitives/hover-card",
		description: "Learn about different languages deal with speaking letters.",
	},
	{
	...
	},
	{
		...
		href: "/docs/primitives/hover-card",
		description: "Encourage early literacy skills.",
	},
];
